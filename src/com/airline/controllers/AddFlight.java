...
public class AddFlight extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		//String from_destination = (String)request.getParameter("from_destination");
	    System.out.println(request.getParameter("to"));
		
	String from_destination = request.getParameter("from");
	f.setFlightOrigin(FlightDestinations.valueOf(from_destination));
	
	String to_destination = request.getParameter("to");
	f.setFlightDestinations(FlightDestinations.valueOf(to_destination));

	//	f.setFlightOrigin(FlightDestinations.London);
	//	f.setFlightDestinations(FlightDestinations.Los_Angeles);
